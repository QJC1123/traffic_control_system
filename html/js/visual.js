...
var data = {
    ...
    // legendLine: ['环比', '同比'],
    xAxis: ['0时','4时','8时','12时','16时','20时','23时'],
    yAxis: [
        [8, 10, 10, 11, 4, 13,8],
        [10, 7, 8, 8, 7, 9,7]
    ],
...
option2 = {
    ...
    series: [{
        ...
        data: [20,35,34,45,52,41,49,64,24,52.4,24,33,22]
    }, {
        name: '中型车',
        type: 'line',
        smooth: true,
        ...
        data: [97.3,99.2,99.3,100.0,99.6,90.6,80.0,91.5,69.8,67.5,90.4,84.9,88]
    }, {
        name: '大型车',
        type: 'line',
        smooth: true,
        ...
        data: [84.2,81.0,67.5,62.1,43.7,68.5,51.9,71.8,76.7,67.6,62.9,0,10]
    }, ]
};
//////////////////////车速 end
